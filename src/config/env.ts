...
export const ENV = {
  ...
  CLIENT_URL: process.env.CLIENT_URL || 'https://hotel-erp-nine.vercel.app',
  WEBSITE_URL: process.env.WEBSITE_URL || 'https://hotel-website-pi-five.vercel.app',
  API_URL: process.env.API_URL || 'https://hotel-backend-mi2r.onrender.com',
  APP_URL: process.env.APP_URL || 'https://hotel-backend-mi2r.onrender.com',
